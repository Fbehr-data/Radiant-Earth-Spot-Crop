...
class FeatureEngineering():
    def __init__(self, ROOT_DIR:str, df:pd.DataFrame, drop_unknown=False, verbose=False) -> None:
    ...
    def drop_cloud_mask(self):
        ...
        self.df = cloud_mask(self.df, drop_unknown=self.drop_unknown, verbose=self.verbose)
